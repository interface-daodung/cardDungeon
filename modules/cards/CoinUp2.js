// CoinUp2.js - Tháº» coin tÄƒng Ä‘iá»ƒm loáº¡i 2
// Chá»©c nÄƒng: Tháº» coin tÄƒng Ä‘iá»ƒm sá»‘

class CoinUp2 extends Card {
    constructor() {
        super(
            "Cá»™ng HÆ°á»Ÿng NguyÃªn Tá»‘: Há»a Nhiá»‡t TÃ¬nh", 
            "coinUp", 
            "resources/coinUp2.webp", 
            "Coin tÄƒng Ä‘iá»ƒm loáº¡i 2"
        );
        this.score = 4; // Äiá»ƒm sá»‘ nháº­n Ä‘Æ°á»£c
    }
    ...
    getDisplayInfo() {
        ...
        return {
            ...baseInfo,
            description: `Coin tÄƒng Ä‘iá»ƒm lá»›n - Nháº­n ${this.score} Ä‘iá»ƒm`,
            score: this.score
        };
    }
} 
