// CoinUp1.js - Tháº» coin tÄƒng Ä‘iá»ƒm loáº¡i 1
// Chá»©c nÄƒng: Tháº» coin tÄƒng Ä‘iá»ƒm sá»‘

class CoinUp1 extends Card {
    constructor() {
        super(
            "Cá»™ng HÆ°á»Ÿng NguyÃªn Tá»‘: Thá»§y Trá»‹ Liá»‡u", 
            "coinUp", 
            "resources/coinUp1.webp", 
            "Coin tÄƒng Ä‘iá»ƒm loáº¡i 1"
        );
        this.score = 3; // Äiá»ƒm sá»‘ nháº­n Ä‘Æ°á»£c
    }
    ...
    getDisplayInfo() {
        ...
        return {
            ...baseInfo,
            description: `Coin tÄƒng Ä‘iá»ƒm vá»«a - Nháº­n ${this.score} Ä‘iá»ƒm`,
            score: this.score
        };
    }
} 
