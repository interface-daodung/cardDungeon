// CoinUp5.js - Tháº» coin tÄƒng Ä‘iá»ƒm loáº¡i 5
// Chá»©c nÄƒng: Tháº» coin tÄƒng Ä‘iá»ƒm sá»‘

class CoinUp5 extends Card {
    constructor() {
        super(
            "Cá»™ng HÆ°á»Ÿng NguyÃªn Tá»‘: Phong Nháº¡y BÃ©n", 
            "coinUp", 
            "resources/coinUp5.webp", 
            "Coin tÄƒng Ä‘iá»ƒm loáº¡i 5"
        );
        this.score = 7; // Äiá»ƒm sá»‘ nháº­n Ä‘Æ°á»£c
    }
    ...
    getDisplayInfo() {
        ...
        return {
            ...baseInfo,
            description: `Coin tÄƒng Ä‘iá»ƒm cá»±c hiáº¿m - Nháº­n ${this.score} Ä‘iá»ƒm`,
            score: this.score
        };
    }
} 
