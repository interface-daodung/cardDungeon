// CoinUp3.js - Tháº» coin tÄƒng Ä‘iá»ƒm loáº¡i 3
// Chá»©c nÄƒng: Tháº» coin tÄƒng Ä‘iá»ƒm sá»‘

class CoinUp3 extends Card {
    constructor() {
        super(
            "Cá»™ng HÆ°á»Ÿng NguyÃªn Tá»‘: LÃ´i Máº¡nh Máº½", 
            "coinUp", 
            "resources/coinUp3.webp", 
            "Coin tÄƒng Ä‘iá»ƒm loáº¡i 3"
        );
        this.score = 5; // Äiá»ƒm sá»‘ nháº­n Ä‘Æ°á»£c
    }
    ...
    getDisplayInfo() {
        ...
        return {
            ...baseInfo,
            description: `Coin tÄƒng Ä‘iá»ƒm quÃ½ - Nháº­n ${this.score} Ä‘iá»ƒm`,
            score: this.score
        };
    }
} 
